...
function AboutView() {
  return (
    <div id='about-section'>
      ...
      <div>
        Currently, I'm a Computer Science student at the Durham University,
        where I'm mainly focused on solving problems through Machine Learning. Aside from my studies, I
      ...
      <div>
        ...
        <ul className='about-list'>
          ...
          <li>Making technology less engagement-driven (Humane Tech)</li>
      ...
      <div>
        ...
        This blog will hopefully allow me to explore a subset of my thoughts in a more
