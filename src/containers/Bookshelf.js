...
class Bookshelf extends React.Component {
	...
	render() {
		...
		let posts = (
			<div id='bookshelf-content' className='ui container left aligned'>
				<h1>Bookshelf</h1>
				<p id='lead-text'>
					I enjoy keeping track of the books I've read and maybe some other
					people will be interested to see. Hence, below is a list of all the
					books I've read recently.
					<br />
					<br />
					For the sake of organisation, I've decided to highlight those I found
					outstanding with
					<span className='green_text'> green</span> and above average books in{' '}
			...
			posts = (
				<div id='bookshelf-content' className='ui container left aligned'>
					...
					<p id='lead-text'>
						...
						found outstanding with
						<span className='green_text'> green</span> and above average books
						in{' '}
						<span className='lightblue_text' style={{ fontWeight: 'bold' }}>
							{' '}
							blue
